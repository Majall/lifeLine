                ...
                <form method="post" action="CRUD/edit_camp_process.php">
                    <div class="main-user-info">
                        ...
                        <div class="user-input-box">
                            ...
                            <input type="text" id="address" name="line1" value="<?php echo $line1; ?>" required/>
                        </div>
                        <div class="user-input-box">
                        ...
                        <div class="user-input-box">
                            ...
                            <input type="text" id="postel code" name="postal_code" value="<?php echo $postalCode; ?>" required/>
                        </div>

                        <div class="user-input-box">
                            <label for="country">Country</label>
                            <input type="text" id="country" name="country" value="<?php echo $country; ?>" placeholder="Enter your country" required/>
